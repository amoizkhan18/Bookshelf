...
const GhostScreen = ({ navigation }) => {
  ...
  const hardcodedImage = require('../assets/dubliners.jpg');
  const hardcodedGenres = ['Short Stories'];
  const hardcodedDescription =
    '"Dubliners" by James Joyce is a collection of short stories written in the late 19th century. The stories explore the everyday lives and struggles of the residents of Dublin, offering a poignant and often critical look at the themes of paralysis, identity, and the quest for meaning within the constraints of society. The opening story, "The Sisters," sets the tone for the collection by introducing a young boy reflecting on the death of Father Flynn, a priest who had a significant, albeit troubling, influence on his life. The opening of "Dubliners" begins with the story "The Sisters," which recounts a young boys complicated feelings following the death of Father Flynn, a friend and mentor. The boy feels a mix of sorrow and relief at the priests passing, as he recalls ambiguous moments from their relationship. While visiting the house of mourning, interactions between the boy, his relatives, and other family friends reveal conflicting views about Father Flynns character and his past. Through vivid descriptions and subtle emotions, Joyce conveys themes of death, guilt, and the search for understanding, leaving the reader with a sense of impending complexity that resonates throughout the entire collection.';

const bookurl = 'https://moizz.work.gd/assets/pg2814-images-3.epub';
  ...
  const similarBooks = [
    { id: '1', title: 'The Prophet', author: 'Kahlil Gibran', image: require('../assets/prophet.jpg'), screen: 'GhostScreen' },
